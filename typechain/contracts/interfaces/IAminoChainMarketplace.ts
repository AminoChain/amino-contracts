...
export interface IAminoChainMarketplaceInterface extends utils.Interface {
  functions: {
...
export interface IAminoChainMarketplace extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAminoChainMarketplaceInterface;
